...
summary: "The journey of creating a flexible and scalable design system"
images:
  - "/images/projects/project-01/cover-04.jpg"
  - "/images/projects/project-01/video-01.mp4"
tag: ["Design System", "UI/UX", "Development"]
team:
  - name: "Selene Yu"
...
This project details the development of Once UI, a comprehensive design system built to streamline the creation of modern web applications.

## Overview

Building a design system from scratch requires careful planning, extensive research, and iterative development. This case study explores the challenges and solutions encountered during the creation of Once UI.
